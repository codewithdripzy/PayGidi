...
1. buyer sends payment to a merchant
2. funds are held securely in escrow
3. merchant completes verification (KYB + identity checks)
4. AI assigns a trust score based on behavior and risk signals
5. funds are released, held, or flagged based on risk level
