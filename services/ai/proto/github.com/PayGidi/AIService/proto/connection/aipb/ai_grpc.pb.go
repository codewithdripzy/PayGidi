...
type AIServiceClient interface {
	...
	ProcessKYB(ctx context.Context, in *ProcessKYBRequest, opts ...grpc.CallOption) (*ProcessKYBResponse, error)
}
...
func (c *aIServiceClient) ProcessKYB(ctx context.Context, in *ProcessKYBRequest, opts ...grpc.CallOption) (*ProcessKYBResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProcessKYBResponse)
	err := c.cc.Invoke(ctx, AIService_ProcessKYB_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AIServiceServer interface {
	...
	ProcessKYB(context.Context, *ProcessKYBRequest) (*ProcessKYBResponse, error)
...
func (UnimplementedAIServiceServer) ProcessKYB(context.Context, *ProcessKYBRequest) (*ProcessKYBResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProcessKYB not implemented")
}
...
func _AIService_ProcessKYB_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProcessKYBRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AIServiceServer).ProcessKYB(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AIService_ProcessKYB_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AIServiceServer).ProcessKYB(ctx, req.(*ProcessKYBRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AIService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ProcessKYB",
			Handler:    _AIService_ProcessKYB_Handler,
		},
	},
